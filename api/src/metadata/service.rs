...
use crate::db::entities::metadata_cache;
...
impl MetadataService {
    ...
    pub async fn search_candidates(
        ...
        let live_results: Vec<Vec<ProspectiveMetadata>> =
    ...
    pub async fn confirm_match(
        ...
        let meta_payload = serde_json::to_value(candidate)
    ...
    pub async fn refresh_metadata(
        ...
        for result in &all_results {
            if !result.provider_id.is_empty() {
                provider_ids.insert(
                    ...
                    serde_json::Value::String(result.provider_id.clone()),
                );
            }
        }
        ...
        let meta_payload = serde_json::to_value(&merged)
            .map_err(|e| AppError::Internal(format!("Serialization error: {e}")))?;
